<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgregarCliente.aspx.cs" Inherits="MedicalManagement.AgregarCliente" %>
...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
    ...
    <table width="100%" border="0">
        <tr>
            <td align="left"><h3>Nuevo Cliente</h3></td>
            <td align="right">
            ...
            <div class="col-xs-12 col-lg-6 col-sm-6 col-md-6">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12 col-lg-6 col-md-6">
                            <asp:TextBox CssClass="form-control" ID="txtRFC" runat="server" Columns="25"></asp:TextBox>
                        </div>
                    </div>
                    <%--<div class="row">
