...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                <asp:DropDownList AutoPostBack="true" runat="Server" CssClass="combobox form-control" OnSelectedIndexChanged="changePaciente" ID="ddlUsuarios" DataTextField="_NombreCompleto" DataValueField="Id_FichaIdentificacion" />
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
