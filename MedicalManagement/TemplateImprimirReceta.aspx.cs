...
{
    public partial class TemplateImprimirReceta : System.Web.UI.Page
    {
        int Id_FichaIdentificacion = 1;
            ...
            if (!IsPostBack)
            {
                ...
                if (Id_FichaIdentificacion != 0)
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        txtTelMovIndent.Text = reader.GetString(reader.GetOrdinal("TelefonoMovil_FichaIdentificacion")).Trim();
                        txtCorreoIdent.Text = reader.GetString(reader.GetOrdinal("CorreoElectronico_FichaIdentificacion")).Trim();
                      //  txtCasoEmeIdent.Text = reader.GetString(reader.GetOrdinal("CasoEmergencia_FichaIdentificacion")).Trim();
                        string imagen = reader.GetString(reader.GetOrdinal("Foto_FichaIdentificacion")).Trim();
                        imagen = imagen.Trim();
                        Session["imagen"] = imagen;
                        Image1.ImageUrl = "ImagenesFicha/" + imagen + "";

                        txtCalleIdent.Text = reader.GetString(reader.GetOrdinal("Direccion_Calle_FichaIdentificacion")).Trim();
                        txtNuIntIdent.Text = reader.GetString(reader.GetOrdinal("Direccion_NoInt_FichaIdentificacion")).Trim();
        ...
        protected void btnGuardar_FichaIdentificacion_Click(object sender, EventArgs e)
        {
            ...
            */
            else if (txtNombreIdent.Text.Length == 0)
            {
