<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Prueba.aspx.cs" Inherits="MedicalManagement.Prueba" %>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="li-main">
                        ...
                        <ul id="ddOperaciones" class="collaps in">
                            <li class="divider"></li>
                            <li>
                     ...
                     <li class="li-main">
                        ...
                        <ul id="ddCatalogos" class="collaps in">
                            <li class="divider"></li>
                            <li>
                    ...
                    <li class="li-main">
                        <a href="forms.html"><i class="fa fa-fw fa-wrench"></i>Configuracion</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
