...
<td align="right">
<asp:ImageButton ID="ImageGrabar" runat="Server" ImageUrl="IMG/Grabar.png"  ToolTip = "Grabar EmpresaConvenio" onclick="btnGuardar_EmpresaConvenio_Click"></asp:ImageButton>&nbsp;
<asp:ImageButton ID="ImageRegresar" runat="Server" ImageUrl="IMG/Regresar.png"  ToolTip = "Regresar" onclick="btnRegresar_EmpresaConvenio_Click"></asp:ImageButton>
</td>
</tr>
<tr>
