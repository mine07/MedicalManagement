...
{
    public partial class EmpresaConvenio : System.Web.UI.Page
    {
        ...
        protected void btnAgregarEmpresaConvenio_Click(object sender, EventArgs e)
        {
            Response.Redirect("RegistroEmpresaConvenio.aspx");
        }
        ...
        protected void RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                ...
                GridViewRow selectedRow = Grid_EmpresaConvenio.Rows[index];
                ...
                System.Web.HttpContext.Current.Response.Redirect("RegistroEmpresaConvenio.aspx?Id_EmpresaConvenio=" + selectedRow.Cells[0].Text);
            ...
            if (e.CommandName == "Delete")
            {
                ...
                int index = Convert.ToInt32(e.CommandArgument);
                GridViewRow selectedRowE = Grid_EmpresaConvenio.Rows[index];
                try
                {
                    Response.Write("<script language=javascript>confirm('Esta seguro que quiere eliminar EmpresaConvenio?');</script>");
                }
                catch (Exception ex)
                {
        ...
        protected void Eliminar(string id_EmpresaConvenio)
        {
            ...
            SqlCommand command = new SqlCommand("SP_Catalogo_EmpresaConvenio", cnn);
            command.CommandType = CommandType.StoredProcedure;
            command.Parameters.AddWithValue("@Opcion", "BAJA");
            command.Parameters.AddWithValue("@Id_EmpresaConvenio", id_EmpresaConvenio);
            command.ExecuteNonQuery();
            command = null;

            String Registro_Operacion_Btacora = "SP_Catalogo_EmpresaConvenio"
                                            + "@Opcion" + " = " + "BAJA"
            ...
            comandoBitacora.Parameters.AddWithValue("@Descripcion_Bitacora", "Baja EmpresaConvenio nueva");
        ...
        public void LlenarGridEmpresaConvenio()
        {
            ...
            if (txtBuscar_EmpresaConvenio.Text == "")
            {
                comando.Parameters.AddWithValue("@RazonSocial_EmpresaConvenio", "");
            }
            else
            {
                comando.Parameters.AddWithValue("@RazonSocial_EmpresaConvenio", txtBuscar_EmpresaConvenio.Text);
            }
            /*
                0  Id_Empresa
                1  Nombre_Empresa
            ...
            da.Fill(ds);
            Grid_EmpresaConvenio.Visible = true;
            Grid_EmpresaConvenio.DataSource = ds;
            Grid_EmpresaConvenio.Columns[0].Visible = true;
            Grid_EmpresaConvenio.Columns[1].Visible = true;
            Grid_EmpresaConvenio.DataBind();
            ds.Dispose();
            da.Dispose();
